...
# SAFE IMPORT: Prevents server crashes if the library is missing
try:
...
class PayrollReportWizard(models.TransientModel):
    ...
    def action_print_report(self):
        ...
        return self.env.ref('custom_hr_payroll_report.payroll_report_action_id_bank_latter').report_action(self,
                                                                                                           data=data)
